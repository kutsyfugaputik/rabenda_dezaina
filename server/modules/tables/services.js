...
const Services = sequelize.define('Services', { 
  // Определяем модель для таблицы 'Services'. Метод 'define' создаёт модель, которая будет соответствовать таблице в базе данных.
    ...
    master_id: { 
      type: DataTypes.INTEGER, 
      // Тип данных для поля 'master_id' — целое число, которое будет ссылаться на идентификатор мастера в таблице 'masters'.
      allowNull: false, 
      // Указываем, что это поле обязательно для заполнения.
      references: { 
        model: Masters, 
